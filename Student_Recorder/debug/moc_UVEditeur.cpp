...
QT_MOC_LITERAL(5, 34, 13)
    ...
    "UVEditeur\0sauverUV\0\0activSave\0str\0"
    "cancelChanges"
};
...
void UVEditeur::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->activSave((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 2: _t->activSave(); break;
...
struct qt_meta_stringdata_UVCreateur_t {
    QByteArrayData data[6];
    char stringdata[48];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_UVCreateur_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_UVCreateur_t qt_meta_stringdata_UVCreateur = {
    {
...
QT_MOC_LITERAL(5, 34, 13)
    ...
    "UVCreateur\0creerUV\0\0activSave\0str\0"
    "cancelChanges"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_UVCreateur[] = {
...
void UVCreateur::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        UVCreateur *_t = static_cast<UVCreateur *>(_o);
        switch (_id) {
        case 0: _t->creerUV(); break;
        case 1: _t->activSave((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 2: _t->activSave(); break;
        case 3: _t->cancelChanges(); break;
        default: ;
...
const QMetaObject UVCreateur::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_UVCreateur.data,
      qt_meta_data_UVCreateur,  qt_static_metacall, 0, 0}
};


const QMetaObject *UVCreateur::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *UVCreateur::qt_metacast(const char *_clname)
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_UVCreateur.stringdata))
        return static_cast<void*>(const_cast< UVCreateur*>(this));
    return QWidget::qt_metacast(_clname);
}

int UVCreateur::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = QWidget::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
